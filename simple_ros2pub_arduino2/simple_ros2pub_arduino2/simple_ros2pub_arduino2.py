...
class SimpleRos2subArduino2(Node):

    def __init__(self):
        super().__init__("simple_ros2pub_arduino2")
...
def main():
    ...
    simple_ros2pub_arduino2 = SimpleRos2subArduino2()
    rclpy.spin(simple_ros2pub_arduino2)
    
    simple_ros2pub_arduino2.destroy_node()
    rclpy.shutdown()
